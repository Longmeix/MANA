from JMAC_EA.modules.load.kg import KG
from JMAC_EA.modules.load.read import generate_sharing_id, generate_mapping_id, uris_relation_triple_2ids, \
    uris_attribute_triple_2ids, uris_pair_2ids, generate_sup_relation_triples, generate_ent_id, \
...
class KGs:
    def __init__(self, kg1: KG, kg2: KG, train_links, test_links, valid_links=None, mode='mapping', ordered=True):
        if mode == "sharing":
            ...
            ent_ids1, ent_ids2, kg1_ent_deg_dict, kg2_ent_deg_dict = generate_ent_id(kg1.relation_triples_set, kg1.entities_set,
                                                     kg2.relation_triples_set, kg2.entities_set, ordered=ordered)
            ...
            #                                            kg2.attribute_triples_set, kg2.attributes_set, ordered=ordered)
        # self.kg1_ent_deg_dict, self.kg2_ent_deg_dict = kg1_ent_deg_dict, kg2_ent_deg_dict
        ...
        # kg1.set_ent_deg_dict(kg1_ent_deg_dict, ent_ids1)
        # kg2.set_ent_deg_dict(kg2_ent_deg_dict, ent_ids2)
