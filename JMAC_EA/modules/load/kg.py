...
class KG:
    def __init__(self, relation_triples, attribute_triples=None):
        ...
        self.relation_triples_num = None
        # self.attribute_triples_num = None
        self.local_relation_triples_num = None
        # self.local_attribute_triples_num = None
    ...
    # need or not for NA?
    # rt收集一个节点的出度邻居情况  rt_dict['xx'] = {(r1,t1), ……} size是邻居个数
    # hr收集入度
    ...
    def set_ent_deg_dict(self, old_ent_deg_dict, entities_id_dict):
        ent_deg_dict = dict()
        for old, new in entities_id_dict.items():
            ent_deg_dict[new] = old_ent_deg_dict[old]
        self.ent_deg_dict = ent_deg_dict
